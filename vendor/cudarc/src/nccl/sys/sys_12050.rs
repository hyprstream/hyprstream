...
#[test]
fn bindgen_test_layout_ncclSimInfo_v22200() {
    const UNINIT: ::core::mem::MaybeUninit<ncclSimInfo_v22200> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<ncclSimInfo_v22200>(),
        24usize,
        concat!("Size of: ", stringify!(ncclSimInfo_v22200))
    );
    assert_eq!(
        ::core::mem::align_of::<ncclSimInfo_v22200>(),
        8usize,
        concat!("Alignment of ", stringify!(ncclSimInfo_v22200))
    );
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).size) as usize - ptr as usize },
        0usize,
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).estimatedTime) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(ncclSimInfo_v22200),
