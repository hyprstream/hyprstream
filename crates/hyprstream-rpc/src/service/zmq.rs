...
///
/// let client = ZmqClient::new("inproc://hyprstream/registry", context, signing_key, identity);
...
mod tests {
    ...
    async fn test_invalid_signature_rejected() {
        ...
        assert!(
            response.is_empty(),
            "Invalid signature should return empty response"
        );
