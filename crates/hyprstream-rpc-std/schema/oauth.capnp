...
struct OauthRequest {
  ...
  union {
    registerUser @1 :RegisterUser
      $scope(manage) $mutationSemantics("idempotency-key-required") $dispatchMac("internal:pq-hybrid") $mcpDescription("Register a new user");
    getUser @2 :Text
    ...
    updateUser @4 :UpdateUser
      $scope(manage) $mutationSemantics("naturally-idempotent") $dispatchMac("internal:pq-hybrid") $mcpDescription("Update user profile fields");
    suspendUser @5 :Text
      $scope(manage) $mutationSemantics("naturally-idempotent") $dispatchMac("internal:pq-hybrid") $mcpDescription("Suspend user (set active=false)");
    resumeUser @6 :Text
      $scope(manage) $mutationSemantics("naturally-idempotent") $dispatchMac("internal:pq-hybrid") $mcpDescription("Resume suspended user (set active=true)");
    removeUser @7 :Text
      $scope(manage) $mutationSemantics("naturally-idempotent") $dispatchMac("internal:pq-hybrid") $mcpDescription("Permanently remove user");
    addPubkey @8 :AddPubkey
      $scope(manage) $mutationSemantics("naturally-idempotent") $dispatchMac("internal:pq-hybrid") $mcpDescription("Add an Ed25519 public key to a user");
    removePubkey @9 :RemovePubkey
      $scope(manage) $mutationSemantics("naturally-idempotent") $dispatchMac("internal:pq-hybrid") $mcpDescription("Remove a public key by fingerprint");
    listPubkeys @10 :Text
