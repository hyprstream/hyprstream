...
pub use hyprstream_rpc_std::discovery_capnp;

// Generated RPC service code. Public clients/data types are re-exported from
// the canonical contract crate; this module adds only AGPL server dispatch.
pub mod generated {
    pub mod discovery_client {
        #![allow(dead_code, unused_imports, unused_variables)]
        #![allow(clippy::all)]
        pub use hyprstream_rpc_std::discovery_client::*;
