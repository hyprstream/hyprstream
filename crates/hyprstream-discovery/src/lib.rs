...
// Canonical Cap'n Proto code is generated by the Apache-2.0 contract crate.

// Generated RPC service code. The canonical contract crate owns all public
// clients/data; this module exposes only AGPL server dispatch helpers.
pub mod generated {
...
mod did_field_domain_type_tests {
    use hyprstream_rpc_std::discovery_capnp;
    use hyprstream_rpc_std::discovery_client::{EnvelopeKeyset, RegisterEnvelopeKeysetRequest};
