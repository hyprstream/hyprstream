...
pub fn build_chat_vfs_namespace(
    ...
    let adapter = crate::services::remote_mount::ModelFsAdapter::new_unscoped(model_client);
    let remote_model_mount = crate::services::remote_mount::RemoteModelMount::new(adapter);
