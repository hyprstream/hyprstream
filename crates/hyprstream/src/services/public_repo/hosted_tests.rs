...
pub(crate) struct Reads(pub AtomicUsize);
            ...
            SyntheticNode::dir().with_child(
                ...
                SyntheticNode::dir()
                    ...
                    .with_child(
                        ...
                        SyntheticNode::file(account.atproto_signing_key().to_bytes().to_vec()),
                    )
                    .with_child(
                        "repo",
                        SyntheticNode::dir()
                            .with_child(
                                "commit.cbor",
                                SyntheticNode::file(genesis.commit_bytes().to_vec()),
                            )
                            .with_child(
                                "public-commit.cbor",
                                SyntheticNode::file(genesis.public_commit_bytes().to_vec()),
                            ),
                    ),
            ),
        ),
