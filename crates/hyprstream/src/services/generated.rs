...
//! for the daemon's handlers only. Client/data consumers must import the
//! canonical `hyprstream_rpc_std` modules directly.
...
pub mod model_client {
    ...
    pub(crate) async fn verified_health_check_response(
    ...
    ) -> anyhow::Result<hyprstream_rpc_std::model_client::ModelResponseVariant> {
        ...
        let response = client
            ...
            .await?;
        hyprstream_rpc_std::model_client::ModelClient::parse_response(&response)
    }
}
