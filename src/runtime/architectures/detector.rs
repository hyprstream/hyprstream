...
impl ArchitectureDetector {
    ...
    pub fn get_expected_shapes(
        ...
        match arch {
            ...
            ModelArchitecture::Qwen { version: 3, is_moe: false, .. } => {
            ...
            ModelArchitecture::Qwen { version: 3, is_moe: true, .. } => {
            ...
            ModelArchitecture::GPTOSS { .. } => {
                ...
                shapes.insert("moe_gate".to_string(), vec![batch_size, seq_len, 128]);    // 128 experts
                shapes.insert("expert_ffn".to_string(), vec![8, batch_size, seq_len, 16384]); // 8 active experts
            }
            ModelArchitecture::GPTJ => {
...
mod tests {
    ...
    fn test_parse_architecture_strings() {
        ...
        match gpt_oss {
            ModelArchitecture::GPTOSS { total_params_b, active_params_b, .. } => {
    ...
    fn test_qwen3_shapes() {
        ...
        let shapes = ArchitectureDetector::get_expected_shapes(
            &ModelArchitecture::Qwen { version: 3, is_moe: false, context_length: 128000 },
            1,
            100,
        );
        ...
        let moe_shapes = ArchitectureDetector::get_expected_shapes(
            &ModelArchitecture::Qwen { version: 3, is_moe: true, context_length: 262144 },
            1,
            100,
        );
