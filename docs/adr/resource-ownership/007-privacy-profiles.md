...
Identified, pairwise-DID, committed-owner, anonymous-controller, and anonymous-payer are separate profiles with typed fields and separate negative controls. Public artifacts use commitments and minimum routing/verifiability data; detailed receipts are encrypted or selectively disclosed. Anonymous commitment constructions remain opaque and production-gated on #1059–#1062.
