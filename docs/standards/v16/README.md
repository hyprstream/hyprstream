...
| [`vectors/`](vectors) | Machine-readable vectors: 8 positive, 48 negative, the seeded test keys, and the replay-namespace thumbprint vectors (`proof-v1-thumbprints.json`) |
